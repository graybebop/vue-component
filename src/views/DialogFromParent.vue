  ...
  <div class="pa-4 text-center">
    ...
    <v-btn-group color="#b2d7ef" density="comfortable" rounded="pill" divided>
      <v-btn class="pe-2" prepend-icon="mdi-account-multiple-outline" variant="flat">
        ...
        <v-dialog activator="parent" max-width="500" attach="#test" transition="dialog-top-transition">
          <template v-slot:default="{ isActive }">
            <v-card rounded="lg">
              ...
              <v-card-text>
                ...
                <div class="text-medium-emphasis mb-1">Share with unlimited people and get more insights about your network. Try Premium Free for 30 days.</div>

                <v-btn class="text-none font-weight-bold ms-n4" color="primary" text="Retry Premium Free" variant="text"></v-btn>
              </v-card-text>
              ...
              <v-card-actions class="my-2 d-flex justify-end">
                ...
                <v-btn class="text-none" color="primary" rounded="xl" text="Send" variant="flat" @click="isActive.value = false"></v-btn>
              </v-card-actions>
            </v-card>
          </template>
        </v-dialog>
