<template>
  <div class="table talbe-stripe">
    <h1 class="pb-3">콤포넌트 리스트</h1>
    <pre>
      작성하신 코드에서 projects 배열의 각 아이템에 포함된 meta 객체의 특정 속성을 렌더링하고 싶으신 것 같아요. meta 객체는 배열이 아니라는 점을 고려하면, 객체의 키-값 쌍을 반복하기 위해서 v-for를 사용해야 합니다. 그리고 특정 조건 하에서만 값(여기서는 'title' 키에 해당하는 값)을 표시하고자 v-if를 사용하셨어요.
